...
**Birdwatching effort is confounded with the treatment.** Summed birdwatcher counts grew 171-fold over 2014–2023 and observed county-months 25-fold, precisely as mean PSI quadrupled (Fig. 1A). The authors control only for `Duration` — the logarithm of birdwatching hours *per birder* — a ratio that discards the explosive growth in total effort. Worse, `Duration` itself responds to PSI (β = −0.0177, *P* < 10⁻⁴), making it a "bad control" that conditions on a post-treatment variable (*4*). Treating birdwatcher numbers as a negative-control outcome exposes the design directly: PSI "reduces" birdwatchers (β = −0.041, *P* = 2 × 10⁻¹¹). This is not a behavioural effect of policy. The association shrinks by 81% within policy-documented counties (β = −0.008, *P* = 0.17); *next-year* PSI "affects" current birdwatchers conditional on current PSI (β = −0.045, *P* < 10⁻⁵) — a causally impossible direction that identifies differential county trends; and PSI does not predict realized PV area within counties (*P* = 0.27), severing any construction-disturbance pathway. A design in which future policy moves a non-ecological outcome will manufacture "effects" on any outcome, birds included.
